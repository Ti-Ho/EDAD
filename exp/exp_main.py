...
class Exp_Main(Exp_Basic):
    ...
    def train(self, setting, args):
        ...
        train_dataset = Dataset_Custom(data=train_data, size=[args.seq_len, args.label_len, args.pred_len],
                                       features=args.features, scale=False, timeenc=timeenc, freq=args.freq)
        train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True,
                                  num_workers=args.num_workers, drop_last=True)
        val_dataset = Dataset_Custom(data=val_data, size=[args.seq_len, args.label_len, args.pred_len],
                                     features=args.features, scale=False, timeenc=timeenc, freq=args.freq)
        val_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False,
                                num_workers=args.num_workers, drop_last=True)
        test_dataset = Dataset_Custom(data=test_data, size=[args.seq_len, args.label_len, args.pred_len],
                                      features=args.features, scale=False, timeenc=timeenc, freq=args.freq)
