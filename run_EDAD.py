...
import os
import torch
from exp.exp_main_ead import Exp_Main
import random
import numpy as np
...
parser.add_argument('--model', type=str, default='Preformer_Recons',
                    help='model name, options: [Preformer, Preformer_Recons]')

# data loader
parser.add_argument('--data', type=str, default='custom', help='dataset type')
parser.add_argument('--root_path', type=str, default='./data/NON10/', help='root path of the data file')
...
# model define
parser.add_argument('--enc_in', type=int, default=500, help='encoder input size')
parser.add_argument('--dec_in', type=int, default=500, help='decoder input size')
parser.add_argument('--c_out', type=int, default=500, help='output size')
...
parser.add_argument("--recons_loss_ratio", type=float, default=1.0)
...
parser.add_argument("--del_epidemic", default=False, type=lambda x: (str(x).lower() == 'true'),
                    help=',whether del epidemic data')
